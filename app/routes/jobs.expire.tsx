 ...
 *
 * This job does:
 *  1) Expire unused redemption codes (ISSUED -> EXPIRED) older than TTL days,
 *     and deactivate OR delete the Shopify discount node.
 *  2) Expire points after 12 months of inactivity (existing behavior).
 *
 * Env:
    ...
    if (r.discountNodeId) {
      if (deleteOnExpire) {
        try {
          ...
          // Fall back to deactivate if delete fails (best effort)
          try {
