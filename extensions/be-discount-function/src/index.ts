...
type Config = {
  ...
  showConfigInMessage: boolean; // true => show trigger/amt/cap in the message
};
...
/**
 * ✅ IMPORTANT: This exact export name is what the compiled function bundle calls.
 * Shopify executes the compiled dist/function.js which wires into this export.
 */
export function cartLinesDiscountsGenerateRun(
  ...
  // Your graph query should be pulling: discount.metafield(namespace:"custom", key:"function-configuration")
  // jsonValue is preferred; value is fallback.
  const rawConfig =
    safeParseJson(mf?.jsonValue) ??
    safeParseJson(mf?.value);
